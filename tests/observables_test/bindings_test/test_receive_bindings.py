...
class TestReceiveBindingMode:
    def test_source_not_sends(
        ...
        binding = Binding(observable_int, observable_str, BindingMode.receive, int_str_converter)
    ...
    def test_multiple_send(
        ...
        assert int_values == [int(value) for value in values]
    ...
    def test_instant_apply(
        ...
        binding = Binding(observable_int, observable_str, BindingMode.receive, int_str_converter, True)

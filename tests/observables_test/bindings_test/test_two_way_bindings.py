...
class TestTwoWayBindingMode:
    def test_source_sends(
        ...
        binding = Binding(observable_int, observable_str, BindingMode.two_way, int_str_converter)
        value = 555
    ...
    def test_multiple_destination_send(
            self,
            observable_int: Observable[int],
            observable_str: Observable[str],
            int_str_converter: Converter):

...
class TestSingleSendBindingMode:
    def test_source_sends(
        ...
        binding = Binding(observable_int, observable_str, BindingMode.single_send, int_str_converter)
        value = 555
    ...
    def test_multiple_send(
        ...
        assert str_values == [str(values[0])]
    ...
    def test_instant_apply(
        ...
        binding = Binding(observable_int, observable_str, BindingMode.single_send, int_str_converter, True)
